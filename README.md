...
see in npx prisma studio. there will be this row in webhookevent table.
if u again run curl -X POST http://localhost:3000/webhooks   -H "Content-Type: application/json"   -H "x-signature: c9100425f79abe575891ae66d8739c87f58f32b19353f54e6ec9b60b6f2e9123"   --data-binary @event.json
then also there will one row.
